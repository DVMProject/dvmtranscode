...
#if defined(_WIN32) || defined(_WIN64)
#define DEFAULT_LOCK_FILE "dvm_transcode.lock"
#else
#define DEFAULT_LOCK_FILE "/tmp/dvm_transcode.lock"
#endif // defined(_WIN32) || defined(_WIN64)
...
/*
** Defined in HostMain.cpp
*/
extern const uint32_t  TRAFFIC_DEFAULT_PORT;

extern const uint8_t   BIT_MASK_TABLE[];

extern const uint8_t   TAG_HEADER;
extern const uint8_t   TAG_DATA;
extern const uint8_t   TAG_LOST;
extern const uint8_t   TAG_EOT;
